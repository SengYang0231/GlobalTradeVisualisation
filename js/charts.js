/* ─────────────────────────────────────────────
   ...
   All 11 charts loaded.
   Chart 9 uses Vega spec (.vg.json) — justified because
   Vega-Lite does not support hierarchical treemap layout.
   All others use Vega-Lite (.vl.json).
───────────────────────────────────────────── */
